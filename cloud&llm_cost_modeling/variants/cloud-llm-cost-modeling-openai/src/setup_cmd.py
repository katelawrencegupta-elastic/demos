...
def patch_tsds_templates():
    from src.variant import active_variant
    if not active_variant().setup_enabled("tsds"):
        print("  [skip] TSDS patch not enabled for this variant")
        return
