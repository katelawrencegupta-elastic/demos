#!/usr/bin/env python3
"""Install and enable Elastic Security curl/wget exfiltration detection rules for this demo.
...
EXFIL_RULE_IDS = [
    "be70614d-4295-473c-a953-582aef41c865",  # Potential Data Exfiltration Through Curl
    "8d8c0b55-ef27-4c20-959f-fa8dd3ac25e6",  # Potential Data Exfiltration Through Wget
]
...
def main() -> None:
    ...
    if not client.can_write_kibana():
        sys.exit(
            ...
            "  Search: Potential Data Exfiltration Through Wget\n"
            "Or create a key with restricted-index write access and set\n"
            "ELASTIC_ADMIN_API_KEY in .env, then rerun."
        )
    ...
    print("Data exfiltration rules:")
    for rule_id in EXFIL_RULE_IDS:
    ...
    print("\nDone. Rule queries logs-endpoint.events.process* (fed by endpoint-process-demo syslog).")
